...
// checkNodeConsistency checks that a node'scope parent/child/sibling relationships
// are consistent.
func checkNodeConsistency(n *Node) error {
	...
	if n.FirstChild != nil && n.FirstChild == n.LastChild {
		...
		if n.FirstChild.PrevSibling != nil || n.FirstChild.NextSibling != nil {
			return fmt.Errorf("html: inconsistent sole child'scope sibling relationship")
		}
	}
