...
The parser is based on golang.org/x/net/html with following modifications:
  ...
  - The original ParseFragment function is removed, since it is always context-aware.
    See StackOverflow post: https://stackoverflow.com/questions/21421704/using-html-parsefragment-in-a-generic-way
...
*/
package chtml // import "golang.org/x/net/html"
